...
PIP_PACKAGES=(
    "--upgrade --force-reinstall --no-cache-dir https://github.com/JamePeng/llama-cpp-python/releases/download/v0.3.32-cu130-Basic-linux-20260308/llama_cpp_python-0.3.32+cu130.basic-cp312-cp312-linux_x86_64.whl"
)
